...
04-audio is **complete** — playable 30-key piano with on-screen note/frequency/wave display. Next big subsystems: SDRAM controller (Wishbone-attached), then RV32I CPU, then UART, then OS/C-program port.
